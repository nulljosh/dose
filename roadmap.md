...
- [x] subtitle empty (en-US) — DONE 2026-07-28: set to "Supplement & Symptom Tracker" via `asc localizations update --type app-info`.
- [x] privacy policy URL empty (en-US) — DONE 2026-07-28: added `public/privacy.html`, deployed to healstack.heyitsmejosh.com/privacy.html, set via `asc localizations update --type app-info`.
